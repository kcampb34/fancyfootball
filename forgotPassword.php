...
<body>
    ...
    <div class="header-container">
        <h1>Complete the Forgot Password Sheet Below</h1>
    </div>

    <!-- Signup Form (Centered) -->
    <div class="form-container">
        <form name="register" action="forgotPasswordAction.php" method="get">
            <div class="item">
            ...
            <div class="item">
                <label>Security Question: Who's your favorite football player?</label>
                <input type="text" name="securityQ" required />
            </div>
            <div class="item">
